...
A pull request for example with components which needs to be applied at the version 1.9.2
...
```sh
git request-pull main https://github.com/CMihai99/medita.git comp-misc-1.9.2
```
...
See [SubmittingPatches.md](https://github.com/CMihai99/medita/blob/main/docs/how-to/maintaining/SubmittingPatches.md)
